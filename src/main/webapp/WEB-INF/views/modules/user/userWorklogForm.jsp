...
<body class="gray-bg pace-running">
	<div class="wrapper wrapper-content">
		...
		<c:when test="${!(userWorklog.id!=null && userWorklog.isdraft=='1')}">
			<form id="inputForm" action="${ctx}/user/userWorklog/save"
				...
				<div class="foot-btn" style="margin:0;">
					<button class="btn btn-primary" onclick="doSubmit()" style="background:#35a5e7;margin:30px 0;">提交</button>&nbsp;
					
					<button class="btn btn-primary" onclick="caogao()" style="background:#35a5e7;margin:30px 0;">草稿</button>&nbsp;
					
					<button class="btn" onclick="history.go(-1)" style="margin:30px 0;">返回</button>
				</div>
		</c:when>

 ...
 <h1 style="text-align:center">${offname }----${cyname }----${StartTime2}月绩效</h1>
		...
		<c:forEach items="${page}" var="cyTspOaMonthlyPlan">
			...
			<tr><td style="display: none;"><input name="id"  type="text" value="${cyTspOaMonthlyPlan.id}" readonly="true"/></td>
				...
				<td>
					...
					<input id="myScores" name="myScores" type="text" style="width:80px" 	 value="${cyTspOaMonthlyPlan.myScores}" readonly="true">
					
				</td>
				
				<td colspan="2">
					<input id="cpleaderScores" style="width:80px" name="leaderScores" type="text" value="${cyTspOaMonthlyPlan.leaderScores}">
				</td>
		 ...
		 <tr>
		  ...
		  <td><input class="btn btn-primary" id="btncp" value="复制打分" onclick="submitcp();" type="button" /></td>
	  ...
	  <script type="text/javascript">
	   function submitcp(){
		   ...
		   var array1=$("input[name='myScores']");
		   var array2=$("input[name='leaderScores']");

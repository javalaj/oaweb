...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnExport").click(function(){
			$("#contentTable").tableExport({worksheetName: '考勤统计',fileName: '考勤统计'+$("#timerec").val(),type:'excel', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});
...
<script type="text/template" id="tpl1">
	<table class='table table-striped table-bordered table-hover table-condensed dataTables-example dataTable'>
		<tbody>
			...
			<tr><td style='color:#ed5565;'>○</td><td>迟到（当天最早刷卡时间晚于08:30:00,研发部另一上班时间为09:30:00）</td></tr>
			<tr><td style='color:#ed5565;'>●</td><td>早退（当天最晚刷卡时间早于17:30:00,研发部另一下班时间为18:30:00）</td></tr>
			<tr><td style='color:#ed5565;'>E</td><td>迟到+早退</td></tr>
			<tr><tr><td style='color:#21b9bb;'>√</td><td>正常（当天既不迟到早退并且最早最晚刷卡时差大于等于9小时的）</td></tr>
			<tr><td style='color:#ed5565;' colspan="2">特殊说明:迟到+早退不再重复参与迟到或者早退的统计项</td></tr>
							...
							<div class="form-group" style="width:100%;">
								<label>部门：
									 <sys:treeselect id="office" name="deptid"
										...
										title="部门" url="/sys/office/treeData?isAll=true" cssClass="form-control"
					...
					<div class="col-sm-12">
						<div class="pull-left">
							<shiro:hasPermission name="oa:coding:oaCoding:edit">
								...
								<input id="btnExport" class="btn btn-white btn-sm" type="button" value="导出" />
							</shiro:hasPermission>
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable" style="white-space: nowrap;" >
					<thead>
						...
						<tr>
							...
							<th colspan="1" style="color: #1c84c6;"><div style='text-align:center'>当月有效上班天数</div></th>
							<th colspan="1" style="color: #1c84c6;"><div style='text-align:center'>日平均工作时长</div></th>
							<th colspan="1" style="color: #1c84c6;"><div style='text-align:center'>当月总工作时长</div></th>

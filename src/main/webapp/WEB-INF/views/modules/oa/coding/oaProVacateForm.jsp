						...
						.validate(
								{
									rules : {
										...
										vacatedays : {
											...
											times : 4,
											min : 4
											<c:if test="${isTX}">,max : $("#restTime").val() * 1</c:if>
										},
										vacatedesc : {
											required : true
										}
		...
		<div class="ibox" style="width: 800px;margin:0 auto;">
			...
			<div class="ibox-content">
				...
				<form:form id="inputForm" modelAttribute="oaProVacate"
					...
					<div class="control-group">
						<label class="control-label">请假开始时间： <font color="red">*</font></label> <input
					...
					<div class="control-group">
						<label class="control-label">请假截止时间：  <font color="red">*</font></label> <input
					...
					<div class="control-group">
						<label class="control-label">请假小时数：  <font color="red">*</font></label>

						<form:input path="vacatedays" htmlEscape="false" maxlength="11"
							id="vacatedays" class="form-control " autocomplete="off" />
						
					</div>
					<c:if test="${!isTX}">
						<div class="control-group">
							<label class="control-label">请假事由：  <font color="red">*</font></label>

							<form:select path="vacatetype" class="selectpicker" data-style="btn-inverse" data-live-search="true">
					...
					<div class="control-group">
						<label class="control-label">请假说明：  <font color="red">*</font></label>

						<form:input path="vacatedesc" htmlEscape="false" maxlength="10000"
							id="vacatedesc" class="form-control " autocomplete="off" />

...
<head>
	...
	<script type="text/javascript">
		...
		function setSelectUserNo(radioObj){  
	        ...
	        function notnull() {
	    		var judge = true;
	    		$("textarea[name='demandOpinion']").each(function() {
	    			var str = "";
...
<div class="ibox-title">
   ...
   <div class="ibox-content">
	...
	<form:form id="inputForm" modelAttribute="oaStaffupdated" action="${ctx}/oa/staff/oaStaffupdated/cmsave" method="post" class="form-inline">
		<form:hidden path="id"/>
		...
		<tr>
			<td>岗位工作内容：</td>
			<td colspan="6">
			<textarea  rows="6"maxlength="200"  cols="100" class="form-control required" disabled="disabled" readonly="readonly">${oaStaffupdated.upPostcontent } </textarea>
			</td>
		</tr>
	<tr>
			<td>增补岗位要求：</td>
		<td colspan="6">
		<textarea  rows="6"maxlength="200" cols="100"   class="form-control required" disabled="disabled" readonly="readonly">${oaStaffupdated.upPostclaim }</textarea>
			</td>
</tr>
	<tr>
			<td>部门副总意见：</td>
		<td colspan="6">
		<form:textarea path="demandOpinion"
...
<tr>
		...
		<td></td>
		<td colspan="6"><shiro:hasPermission name="oa:staff:oaStaffupdated:edit"><input id="btnSubmit1" class="btn btn-myoa-sec btn-myoa-large" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

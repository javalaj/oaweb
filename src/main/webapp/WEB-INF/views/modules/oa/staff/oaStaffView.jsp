...
<div class="ibox-title">
   ...
   <div class="ibox-content">
	...
	<div class="col-sm-12">
	<input id="btnImport1"
			class="btn btn-myoa noprint" type="button" onclick="Import();" value="打印" />
	<br/>
	</div>
	</div>
	...
	<form:form id="inputForm" modelAttribute="oaStaffupdated" action="${ctx}/oa/staff/oaStaffupdated/save" method="post" class="form-inline">
		...
		<div style="overflow: hidden;">
			<span style="display: inline-block; width: 72%;">申请人：${oaStaffupdated.createBy.name }</span>
			<span>申请时间：	
		...
		<tr class="noprint">
		<td></td>
		<td colspan="5" class="noprint"> 	<input id="btnCancel" class="btn btn-myoa noprint" type="button" value="返回" onclick="history();"/>&nbsp;<act:flow-back-btn-Staff></act:flow-back-btn-Staff>	
		<c:if test="${task != null}">
				&nbsp;<input

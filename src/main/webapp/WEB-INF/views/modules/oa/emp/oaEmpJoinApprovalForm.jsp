	...
	<form:form id="inputForm" modelAttribute="oaEmpJoinApproval" action="${ctx}/oa/emp/oaEmpJoinApproval/save" method="post" class="form-horizontal">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
			...
			<tr>
				...
				<td class="active" ><span class="sgin-red">性别</span></td>
				<td class="width-35">
					<c:if test="${oaEmpJoinApproval.isStart ne '1' or oaEmpJoinApproval.act.taskDefKey eq 'exam1'}">
					...
					<td class="active" ><span class="sgin-red">民族</span></td>
					<td class="width-35">
						<c:if test="${oaEmpJoinApproval.isStart ne '1' or oaEmpJoinApproval.act.taskDefKey eq 'exam1'}">
			...
			<tr>
				...
				<td class="active" ><span class="sgin-red">职务</span></td>
				<td class="width-35">
					<c:if test="${oaEmpJoinApproval.isStart ne '1' or oaEmpJoinApproval.act.taskDefKey eq 'exam1'}">
				...
				<td class="active" ><span class="sgin-red">职称</span></td>
				<td class="width-35">
					<c:if test="${oaEmpJoinApproval.isStart ne '1' or oaEmpJoinApproval.act.taskDefKey eq 'exam1'}">
			...
			<tr>
				...
				<td class="active" ><span class="sgin-red">最高学历</span></td>
				<td class="width-35">
					<c:if test="${oaEmpJoinApproval.isStart ne '1' or oaEmpJoinApproval.act.taskDefKey eq 'exam1'}">
			...
			<tr>
				...
				<td class="active" ><span class="sgin-red">现家庭住址</span></td>
				<td colspan="3">
					<c:if test="${oaEmpJoinApproval.isStart ne '1' or oaEmpJoinApproval.act.taskDefKey eq 'exam1'}">

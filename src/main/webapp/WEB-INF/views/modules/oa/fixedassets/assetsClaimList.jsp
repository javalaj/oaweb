		...
		$(document).ready(function()
		 {
			$("#btnExport").click(function(){
	            ...
	            { */
	    	        ...
	    	        var name = "固定资产-已领用" + timex;
					$("#exportTable2").tableExport({worksheetName: '固定资产-已领用',fileName: name,type:'excel', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});
	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
			<ul class="nav nav-tabs myoa-tabs">
				...
				<li class="active"><a href="${ctx}/fixedassets/assetsEquipment/claimList?assetsEquipment.condition=3">已领用</a></li>
		...
		<div class="ibox-content">
			...
			<div class="row">
				<div class="col-sm-12">
					<form:form id="searchForm" modelAttribute="assetsEquipment" action="${ctx}/fixedassets/assetsEquipment/claimList?assetsEquipment.condition=3" method="post" class="breadcrumb form-search">

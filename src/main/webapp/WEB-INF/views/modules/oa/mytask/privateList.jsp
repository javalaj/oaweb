   ...
   <div class="ibox-content">
	...
	<form:form id="inputForm" modelAttribute="oaPlan" action="${ctx}/oa/mytask/oaPlan/save" method="post" class="form-inline">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
			<tr>
				<td style="text-align: center">计划类型： <font color="red">*</font></td>
				<td>
				...
				<td style="text-align: center">活动日期： <font color="red">*</font></td>
				<td>
				<input name="startDay" type="text" readonly="readonly" maxlength="20" class="laydate-icon form-control required"
		...
		<tr>
			<td style="text-align: center">活动主题： <font color="red">*</font></td>
			<td colspan="4">
		...
		<tr>
			...
			<tr>
				<td style="text-align: center">开始时间： <font color="red">*</font></td>
				<td >
				<input name="startTime" type="text" readonly="readonly" maxlength="20" class="laydate-icon form-control required"
					...
					<td style="text-align: center">结束时间： <font color="red">*</font></td>
					<td>
					<input name="endTime" type="text" readonly="readonly" maxlength="20" class="laydate-icon form-control required "

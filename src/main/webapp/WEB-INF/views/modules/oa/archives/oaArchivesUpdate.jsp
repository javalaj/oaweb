...
<%-- 							<form:option value="2" label="普通" /> --%>
				...
				<tr>
					<td class="all"><label class="control-label">核稿人(时间)：</label>
  					<form:input path="leadText" htmlEscape="false" maxlength="20"  class="form-control" style="width:50%;" readonly="true"/>
					<td><label class="control-label">拟稿部门和拟稿人：</label>
						<input type="text" value="${fns:getUser().office.name}&nbsp;${createname}&nbsp; <fmt:formatDate
							value="${oaArchives.draftdate}" pattern="yyyy-MM-dd" />" class="form-control" style="width:50%;" readonly="readonly"/>
				</tr>
				 <tr>

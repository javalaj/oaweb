		...
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a
						href="${ctx}/oa/oaSpacialLoan/exam?num=2&id=${oaSpacialLoan.id}">审核-专项借支申请</a></li>
				</ul>
				<br />
				 --%>
				<form:form id="inputForm" modelAttribute="oaSpacialLoan"
					...
					<div class="control-group">
						<label class="control-label">是否交由总经理审批：</label> <input
							class="i-checks" type="radio" name="next" value="0">是 <input
							type="radio" class="i-checks" name="next" value="1"
							checked="checked">否
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<form:input path="examtext2" htmlEscape="false" maxlength="230"

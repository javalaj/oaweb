...
<body>
	<form:form id="inputForm" modelAttribute="oaContractPurchaseStage" action="${ctx}/oa/contract/oaContractSubStage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-condensed dataTables-example dataTable no-footer myoa-newitem-table">
			...
			<tr>
				...
				<td>
					<form:select path="isWorkProgressCompleted" class="form-control selectpicker required" data-style="btn-inverse" data-live-search="true" id="isWorkProgressCompleted">
			...
			<tr>
				...
				<td>
					...
					<sys:ckfinder input="workProgressFile" type="files" uploadPath="/oa/contract/oaContractSubStage" selectMultiple="true"/>
				</td>
			</tr>
			<tr>
				<td>备注信息</td>

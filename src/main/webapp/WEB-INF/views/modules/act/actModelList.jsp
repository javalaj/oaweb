...
<button class="btn btn-white btn-sm " data-toggle="tooltip"
						data-placement="left" onclick="openDialog('新建模型', '${ctx}/act/model/create','800px', '320px')" title="新建模型">
		...
		<div style="width: 100%;overflow: auto;margin-bottom: 6px;" id="tableContent">
			<table class="table table-striped table-bordered table-hover table-condensed  dataTables-example dataTable no-footer myoa-table-width280">
				<thead>
					<tr>
				...
				<tbody>
					<c:forEach items="${page.list}" var="model">
						<tr>
							...
							<td title="${model.key}">${model.key}</td>

...
<body class="mui-ios mui-ios-9 mui-ios-9-1" style="background-color: #f7f7f7;">
	<div class="team-header">
		<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-primary" style="border-color: #12b7f5;">
			<a class="mui-control-item mui-active" id="myself">我发布的通知</a> 
			<a class="mui-control-item" id="others">我收到的通知</a>
		</div>
	</div>
 	<header class="mui-bar mui-bar-nav" style="position: fixed; top:48px; left: 0; z-index: 997;">
		<a class="mui-icon mui-icon-search" onclick="searchSlideToggle();" style="color:#666;"></a>
		<h1 class="mui-title">通告发布列表</h1>
		<shiro:hasPermission name="oa:oaNotify:edit">
			<a class="mui-icon mui-icon-plus mui-pull-right"  style="color:#666;" onclick="window.location.href='${ctx}/m/oa/oaNotify/form'" id="addNotice"></a>
		</shiro:hasPermission>
	</header>
	<div class="mui-content" style="background-color: #fff;padding-top:94px;">
						...
						<c:forEach items="${page.list}" var="oaNotify" varStatus="status">
							<li class="mui-table-view-cell" >
								...
								<p>
			                    	...
			                    	<span>${fns:getDictLabel(oaNotify.type, 'oa_notify_type', '')}</span>

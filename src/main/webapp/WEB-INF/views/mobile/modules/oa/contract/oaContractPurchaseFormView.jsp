...
<oam:body>
 	<oam:header>
		<a class="mui-icon mui-icon-back mui-pull-left" onclick="location.href='${mctx}/oa/contract/oaContractPurchase/'"></a>
		<h1 class="mui-title">采购合同查看</h1>
	</oam:header>
	<oam:message content="${message}"/>
	<oam:content>
		<oam:form id="inputForm" modelAttribute="oaContractPurchase" action="${mctx}/oa/contract/oaContractPurchase/save" method="post">
			<form:hidden path="id"/>
			<oam:listView>
				...
				<oam:listViewCell title="验货状态:" cellType="input" >
					${fns:getDictLabel(oaContractPurchase.isInspected, 'oa_contract_purchase_is_inspected', '')}
				</oam:listViewCell>
				<oam:listViewCell title="验货单:" cellType="input" >

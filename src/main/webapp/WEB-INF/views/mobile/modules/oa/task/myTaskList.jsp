	...
	<body class="teamwork">	
		<div class="team-header">
			<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-primary">
				<a class="mui-control-item " id="list">我布置的任务</a>
				<a class="mui-control-item  mui-active" id="mylist"	>我收到的任务</a>
			</div>
		</div>
		<div class="main-tit teamtask-tit" style="margin-top:48px;">
			<span>我收到的任务</span> <%-- <a class="mui-pull-right"
				...
				<div id="query" class="mui-content" style="display: none;width:100%;margin-top:-1px;">
					...
					<ul class="userinfo-edit search-edit">
							<li><label class="form-left">任务名:</label>
								<input type="text" id="plantitle" name="planTitle" value="" />
							</li>
					...
					<div>
						<ul class="mui-table-view ">
							<c:forEach items="${page.list}" var="oaTask">
								...
								<a href="${ctx}/m/oa/mytask/myTask/myup?id=${oaTask.id}">									
									<div class="mui-row">
										...
										<%-- 	<img class="mui-media-object mui-pull-left"
												...
												<span>${oaTask.createBy.name }</span>
...
/* 	document.getElementById("a1").setAttribute("class", "thisstatea");
	...
	location.href="${ctx}/m/oa/mytask/myTask/mytaskState?State=1";
}
/*进行中点击*/
function click2() {
	/*样式改变*/
/* 	document.getElementById("a1").setAttribute("class", "statea");
	...
	document.getElementById("a3").setAttribute("class", "statea"); */
	location.href="${ctx}/m/oa/mytask/myTask/mytaskState?State=2";
}
/*进行中点击*/
function click3() {
	/*样式改变*/
/* 	document.getElementById("a1").setAttribute("class", "statea");
	...
	location.href="${ctx}/m/oa/mytask/myTask/mytaskState?State=3";
}
</script>
	</body>

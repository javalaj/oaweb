...
<body>
	...
	<div class="mui-content">
		...
		<ul class="mui-table-view divcontent">
			...
			<li class="mui-table-view-cell"><span> 申请人&emsp;&emsp;：</span> <span>${oaOutwork.createBy.name }</span>
			</li>
			...
			<li class="mui-table-view-cell"><span> 目的地&emsp;&emsp;：</span> <span>${oaOutwork.address }</span>
			</li>
			...
			<li class="mui-table-view-cell"><span> 开始时间&emsp;：</span> <span><fmt:formatDate
						value="${oaOutwork.startTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span></li>
			...
			<li class="mui-table-view-cell"><span> 财务报销情况：</span> <span>${oaOutwork.examtext4}</span>
			</li>
		</ul>

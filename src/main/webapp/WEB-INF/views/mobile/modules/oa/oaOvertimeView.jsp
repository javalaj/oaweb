...
<body>
	...
	<div class="mui-content">
		...
		<ul class="mui-table-view divcontent">
			...
			<li class="mui-table-view-cell" id="content1"><span>申请日期：</span>
				<span><fmt:formatDate value="${oaOvertime.createDate}"
						pattern="yyyy-MM-dd" /></span></li>
			<li class="mui-table-view-cell" id="content2"><span>开始时间：</span>
				<span><fmt:formatDate value="${oaOvertime.starttime}"
						pattern="yyyy-MM-dd HH:mm:ss" /></span></li>
			<li class="mui-table-view-cell" id="content3"><span>截止时间：</span>
				<span><fmt:formatDate value="${oaOvertime.endtime}"
						pattern="yyyy-MM-dd HH:mm:ss" /></span></li>
			<li class="mui-table-view-cell" id="content4"><span>加班时长：</span>
				<span>${oaOvertime.time}</span></li>
			<li class="mui-table-view-cell" id="content6"><span>加班理由：</span>

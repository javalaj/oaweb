...
<body>
	...
	<div class="mui-content">
		...
		<div class="divcontent">
			<form action="${mctx}/oa/oaGoout/dealFilling" method="post"
				id="inputForm">
				...
				<input type="hidden" name="procInsId"
					...
					type="hidden" name="time" value="${oaGoout.time }"><input
					type="hidden" name="reason" value="${oaGoout.reason }"><input
					type="hidden" name="examname" value="${oaGoout.examname }"><input
					type="hidden" name="examtext" value="${oaGoout.examtext }"><input
				...
				<ul class="mui-table-view divcontent">
					...
					<li class="mui-table-view-cell" id="content11"><span>审批留言：</span>

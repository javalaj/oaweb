    ...
    function r(n, r, l) {
        ...
        function b(t) {
            if (g()) {
                ...
                var a = new Date;
                a >= te.start && te.end > a ? $.disableButton("今天") : $.enableButton("今天"),
                ue--,
    ...
    function re(e, n, r) {
        ...
        function s(n) {
            ...
            for (s += "</tr></thead><tbody>", r = 0; ne > r; r++) {
                ...
                s += "<td ondblclick='dbclickfuntion()' class='" + i.join(" ") + "'" + " data-date='" + Fe(o, "yyyy-MM-dd") + "'" + ">" + "<div class='cz'>",
                n && (s += "<div id='d' class='fc-day-number'>" + o.getDate() + "</div>"),

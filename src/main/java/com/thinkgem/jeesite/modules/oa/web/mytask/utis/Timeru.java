...
public class Timeru {
	...
	// 定时器
	public static void autoExe(String tt,String title,String cruse,String count,String flag) {

		final String titlei=title;
		final String crusei=cruse;	
		final String counti=count;
		final String flagstate=flag;
		// 一天总毫秒数
		...
		try{
			...
			TimerTask task = new TimerTask() {
				...
				public void run() {
					...
					oanotify.setTitle("【会议："+titlei+"】-开始提醒");
					}else if(flagstate.equals("0")){
						oanotify.setTitle("【个人活动："+titlei+"】-开始提醒");
					}

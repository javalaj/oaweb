...
public class OaContractPurchaseService extends CrudService<OaContractPurchaseDao, OaContractPurchase> {
	@Autowired
	private OaContractPurchaseStageDao oaContractPurchaseStageDao;
	
	@Autowired
	private OaContractPurchaseProductDao oaContractPurchaseProductDao;
	public OaContractPurchase get(String id) {
		...
		oaContractPurchase.setOaContractPurchaseProductList(oaContractPurchaseProductDao.findList(new OaContractPurchaseProduct(oaContractPurchase)));
	...
	public void save(OaContractPurchase oaContractPurchase) {
		if (oaContractPurchase.getIsNewRecord()){
			...
			oaContractPurchase.setContractType("0");
			oaContractPurchase.setIsInspected("0");
			oaContractPurchase.setIsAddStageAbled("0");
			if (StringUtils.isBlank(oaContractPurchase.getContractNo())) {
				oaContractPurchase.setContractNo(OrdersUtils.getGenerateOrderNo4("CG-"));
			}
	...
	public void delete(OaContractPurchase oaContractPurchase) {
		...
		oaContractPurchaseProductDao.delete(new OaContractPurchaseProduct(oaContractPurchase));
	}

 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/oa/contract/oaContractPurchaseStage")
public class OaContractPurchaseStageController extends BaseController {
	...
	@RequiresPermissions("oa:contract:oaContractPurchaseStage:view")
	...
	public String list(OaContractPurchaseStage oaContractPurchaseStage, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/oa/contract/oaContractPurchaseStageList";
	}
	...
	public String form(OaContractPurchaseStage oaContractPurchaseStage, Model model) {
		...
		return "modules/oa/contract/oaContractPurchaseStageForm";
	}
	...
	public String formAdd(OaContractPurchaseStage oaContractPurchaseStage, Model model) {
		model.addAttribute("oaContractPurchaseStage", oaContractPurchaseStage);
		return "modules/oa/contract/oaContractPurchaseStageFormAdd";
	}

	@RequiresPermissions("oa:contract:oaContractPurchaseStage:edit")
	...
	@RequiresPermissions("oa:contract:oaContractPurchaseStage:saveAdd")
	...
	public String saveAdd(OaContractPurchaseStage oaContractPurchaseStage, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/oa/contract/oaContractPurchase/form?id="+oaContractPurchaseStage.getContractPurchase().getId()+"&tabIndex=1";
	}
	...
	public String delete(OaContractPurchaseStage oaContractPurchaseStage, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/oa/contract/oaContractPurchaseStage/?repage";
	}

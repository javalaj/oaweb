 ...
 */
package com.thinkgem.jeesite.mobile.modules.act.web;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}${mobilePath}/act/task")
public class actTaskControllerMobile extends BaseController {
	...
	public String todoList(Act act, HttpServletResponse response, Model model,HttpServletRequest request) throws Exception {
		...
		return "mobile/modules/act/actTaskTodoList";
	}
	...
	public String historicList(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		...
		return "mobile/modules/act/actTaskHistoricList";
	}
	...
	public String tosendList(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		...
		return "mobile/modules/act/actTaskToSendList";
	}
	/**
	 * 错误页面
	 * 
	...
	public String error(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		return "error/405";
	}
	...
	public String tosearchList(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		...
		return "mobile/modules/act/actTaskSearchList";
	}
	...
	public String histoicFlow(Act act, String startAct, String endAct, Model model){
		...
		return "mobile/modules/act/actTaskHistoricFlow";
	}
	...
	public String processList(String category, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "mobile/modules/act/actTaskProcessList";
	}

...
public class OfficeController extends BaseController {
	...
	public String list(Office office,String parentIds, Model model) {
		model.addAttribute("list", officeService.findList(office));
		/*List<Office> offices=officeService.findAll();
		main=new ArrayList<Office>();
		findChild(office, offices);*/
		model.addAttribute("currentOffice", office);
		return "modules/sys/officeList";
	}
	/*private List<Office> main;
	void findChild(Office root,List<Office> offices){
		List<Office> result=new ArrayList<Office>();
		for (Office office : offices) {
			if (StringUtils.equals(root.getId(), office.getParent().getId())) {
				result.add(office);
				main.add(office);
			}
		}

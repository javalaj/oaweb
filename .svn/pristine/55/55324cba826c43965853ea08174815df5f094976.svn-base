...
<body class="gray-bg">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/oa/oaOutwork/exam2?id=${oaOutwork.id}">审核-出差申请</a></li>
	</ul>
	<br />--%>
				<form:form id="inputForm" modelAttribute="oaOutwork"
					action="${ctx}/oa/oaOutwork/dealExam2" method="post"
					class="form-inline">
					...
					<input name="newsign" type="hidden" value="${newsign}">
					...
					<div class="control-group">
						...
						<input name="examtextNew" type="text" 
							class="form-control" />
					</div>

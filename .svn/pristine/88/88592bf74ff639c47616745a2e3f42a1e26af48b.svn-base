		...
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a
						href="${ctx}/oa/oaGoout/exam?id=${oaGoout.id}">审核-外出申请</a></li>
				</ul>
				<br />
				 --%>
				<form:form id="inputForm" modelAttribute="oaGoout"
					action="${ctx}/oa/oaGoout/dealExam" method="post"
					class="form-inline">
					...
					<div class="control-group">
						<label class="control-label">上级意见：</label>

						<input name="examtext" type="text" maxlength="255"

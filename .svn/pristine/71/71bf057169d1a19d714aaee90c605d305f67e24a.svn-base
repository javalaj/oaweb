...
<body>
	...
	<div class="mui-content">
		<form method="post" action="${mctx}/oa/oaGoout/save" id="vacateForm">
	...
	<script type="text/javascript">
		...
		function validate() {
			...
			if (!judge) {
				...
				nowdate2.setMilliseconds(0);
				nowdate2.setTime(nowdate2.getTime() - 3 * 24 * 60 * 60 * 1000);
				...
				if (date1 < nowdate2) {
					judge = false;
					new_alert("开始时间必须大于 "
							+ nowdate2.format("yyyy-MM-dd HH:mm:ss") + " ", " ");
					return judge;
				}

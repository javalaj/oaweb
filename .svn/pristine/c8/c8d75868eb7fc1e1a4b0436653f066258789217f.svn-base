		...
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a
						href="${ctx}/oa/oaOvertime/filling?id=${oaOvertime.id}">归档-加班申请</a></li>
				</ul>
				<br />
				--%>
				<form:form id="inputForm" modelAttribute="oaOvertime"
					action="${ctx}/oa/oaOvertime/dealFilling" method="post"
					class="form-inline">
					<form:hidden path="id" />
					...
					<div class="control-group">
						<label class="control-label">加班理由：</label> <div class="lc-view-div">${oaOvertime.reason }<br></div>
					</div>
					<div class="control-group">
						<label class="control-label">审批人签名：</label> ${oaOvertime.examname }
					</div>
					<div class="control-group">
						<label class="control-label">审批人意见：</label> <div class="lc-view-div">${oaOvertime.examtext }<br></div>
					</div>
					<div class="control-group">

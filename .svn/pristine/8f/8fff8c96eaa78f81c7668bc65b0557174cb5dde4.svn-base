...
<body>
	...
	<form id="inputForm" action="${ctx}/m/oa/oaSealUse/dealExam" method="post">
		...
		<input type="hidden" value="${oaSealUse.examname}" name="examname" />
		<input type="hidden" value="${oaSealUse.examtext}" name="examtext" />
<%-- 		<input type="hidden" value="${oaSealUse.createBy.name}" name="createBy.id" /> --%>
		...
		<ul class="mui-table-view divcontent">
			...
			<li class="mui-table-view-cell" id="content11"><span>行政留言：</span>
				<input type="text" name="examtext2" class="inputs" maxlength="800">
			</li>
		</ul>

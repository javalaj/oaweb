		...
		<div class="ibox" style="width: 800px;margin: 0 auto;">
			...
			<div class="ibox-content">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a
						href="${ctx}/oa/oaOutwork/filling?id=${oaOutwork.id}">归档-出差申请</a></li>
				</ul>
				<br />
				 --%>
				<form:form id="inputForm" modelAttribute="oaOutwork"
					action="${ctx}/oa/oaOutwork/dealFilling" method="post"
					class="form-inline">
					...
					<div class="control-group">
						<label class="control-label">审批意见：</label> <input type="text"
							name="ftext" maxlength="255" class="form-control" />

...
<body>
	<ul class="nav nav-tabs">
		<li ><a href="${ctx}/oa/oaEquipment/">全部</a></li>
		
		<li class="active"><a href="${ctx}/oa/oaEquipment/form?id=${oaEquipment.id}">固定资产<shiro:hasPermission name="oa:oaEquipment:edit">${not empty oaEquipment.id?'修改':'登记'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaEquipment:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaEquipment" action="${ctx}/oa/oaEquipment/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="ename" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="type" class="input-xlarge required">
					...
					<form:options items="${fns:getDictList('equ_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="ebrand" class="input-xlarge required">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="specs" class="input-xlarge required">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('equ_specs')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="count" htmlEscape="false" maxlength="100" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="indate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${oaEquipment.indate}" pattern="yyyy-MM-dd HH:mm:ss"/>"

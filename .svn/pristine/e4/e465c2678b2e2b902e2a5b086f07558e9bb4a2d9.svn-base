...
<body>
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<table class="table table-condensed dataTables-example dataTable no-footer myoa-table-noborder">
		   <tbody>
		      <tr>
		         <td class="width-15"><label>上级菜单:</label></td>
		         <td class="width-35"><sys:treeselect id="menu" name="parent.id" value="${menu.parent.id}" labelName="parent.name" labelValue="${menu.parent.name}"
					title="菜单" url="/sys/menu/treeData" extId="${menu.id}" cssClass="form-control required"  allowClear="true"/></td>
		         <td class="width-15"><label>名称: <font color="red">*</font></label></td>
		         <td class="width-35"><form:input path="name" htmlEscape="false" maxlength="50" class="required form-control "/></td>
		      </tr>
		      <tr>
		         <td class="width-15"><label>链接:</label></td>
		         ...
		         <td class="width-15"><label>目标:</label></td>
		      ...
		      <tr>
		         <td class="width-15"><label>图标:</label></td>
		         <td class="width-35"><sys:iconselect id="icon" name="icon" value="${menu.icon}"/></td>
		         <td class="width-15"><label>排序:</label></td>
		      ...
		      <tr>
		         <td class="width-15"><label>可见:</label></td>
		         ...
		         <td class="width-15"><label>权限标识:</label></td>

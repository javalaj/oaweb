		...
		$(document).ready(function()
		 {
			...
			$("#btnExport").click(function(){
	            ...
	            { */
	    	        ...
	    	        var name = "固定资产-全部" + timex;
					$("#exportTable2").tableExport({worksheetName: '固定资产-全部',fileName: name,type:'excel', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});
...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
		...
		<div class="ibox-content">
			...
			<div class="row">
				<div class="col-sm-12">
					<form:form id="searchForm" modelAttribute="assetsEquipment" action="${ctx}/fixedassets/assetsEquipment/" method="post" class="breadcrumb form-search">

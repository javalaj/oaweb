...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/oaOvertime/">加班申请成功列表</a></li>
	</ul>
		...
		<c:forEach items="${page.list}" var="oaOvertime">
			<tr>
				...
				<shiro:hasPermission name="oa:oaOvertime:edit"><td>
					...
					<a href="${ctx}/oa/oaOvertime/delete?id=${oaOvertime.id}" onclick="return confirmx('确认要删除该加班申请成功吗？', this.href)">删除</a>

...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">审核请假/调休申请</h1>
	</header>
	<div class="mui-content">
		...
		<div class="divcontent">
			<form action="${mctx}/oa/coding/oaProVacate/dealExam" method="post"
				id="inputForm">
				...
				'pro_vacate_type', '')}&nbsp;</span>
					...
					<li class="mui-table-view-cell"><span> 审批意见：</span> <span style="width:60%;"><input
							type="radio" name="exam" value="1" class="exam" />同意 <input
							type="radio" class="exam" name="exam" value="0" checked="checked" />不同意</span></li>
					<li class="mui-table-view-cell"><span> 审批留言：</span> <input
						class="inputs" type="text" name="examOpinion"></li>
				</ul>
			</form>
		</div>

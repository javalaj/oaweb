...
public class SystemService extends BaseService implements InitializingBean {
	...
	// 查询离职员工档案
	public Page<User> findProfileOutState(Page<User> page, User user) {
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
		page.setList(userDao.getProfileOutState(user));
		return page;
	}

	// 查询在职员工档案
	public Page<User> findProfile(Page<User> page, User user) {
		// 设置分页参数
		user.setPage(page);
		// 执行分页查询
		page.setList(userDao.getProfile(user));
		return page;
	}
	...
	public Integer queryMyPlan(String userId, Date beginTime, Date endTime, String state) {
		return userDao.queryMyPlan(userId, beginTime, endTime, state);
	}
	...
	public Integer queryCongressSponsored(String userId, Date beginTime, Date endTime) {
		return userDao.queryCongressSponsored(userId, beginTime, endTime);
	}
	...
	public Integer queryCongressAttend(String userId, Date beginTime, Date endTime) {
		return userDao.queryCongressAttend(userId, beginTime, endTime);
	}
	...
	public Integer queryNewFavorite(String userId, Date beginTime, Date endTime) {
		return userDao.queryNewFavorite(userId, beginTime, endTime);
	}
	...
	public Integer queryDelFavorite(String userId, Date beginTime, Date endTime) {
		return userDao.queryDelFavorite(userId, beginTime, endTime);
	}
	...
	public Integer querySumFavorite(String userId) {
		return userDao.querySumFavorite(userId);
	}
	 ...
	 **/
	@Transactional(readOnly = false)
	public void updateStateById(User user) {
	...
	public Integer queryMeeting(String userId, Date time) {
		return userDao.queryMeeting(userId, time);
	}
	...
	public Integer queryWorkLog(String isdone, String userId, Date beginTime, Date endTime) {
		return userDao.queryWorkLog(isdone, userId, beginTime, endTime);
	}
	...
	public Integer queryWorkLogForWorkColumn(String isdone, String userId) {
		return userDao.queryWorkLogForWorkColumn(isdone, userId);
	}

	/** 修改可调休时长 */
	@Transactional(readOnly = false)
	public void updateResttime(String userid, String resttime) {
		/* 线程安全 */
		// synchronized (UserUtils.getUser()) {
		userDao.updateResttime(userid, resttime);
		// }
	}

	/** 查询可调休时长 */
	public String selectResttime(String userid) {
		String result = userDao.selectResttime(userid);

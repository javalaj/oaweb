...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">归档忘记打卡申请</h1>
	</header>
	<div class="mui-content">
		...
		<div class="divcontent">
			<form action="${mctx}/oa/oaForgetclock/dealFilling" method="post"
				id="inputForm">
				...
				<input type="hidden" name="procInsId"
					...
					type="hidden" name="time" value="${oaForgetclock.time }"><input
					type="hidden" name="reason" value="${oaForgetclock.reason }"><input
					type="hidden" name="examname" value="${oaForgetclock.examname }"><input
					type="hidden" name="examtext" value="${oaForgetclock.examtext }"><input
					type="hidden" name="officename"
					value="${oaForgetclock.officename }"> --%>
				...
				<ul class="mui-table-view divcontent">
					...
					<li class="mui-table-view-cell" id="content11"><span>审批留言：</span><span>
							<input type="text" name="examtext2" class="inputs" style="width:100%;">
					</span></li>
				</ul>

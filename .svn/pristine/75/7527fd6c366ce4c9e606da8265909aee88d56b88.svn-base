			...
			<div id="mainContent" class="ibox-content" style="padding: 0px 10px 20px 10px;">
				<div id="content" style="height:100%;">
					...
					<div id="right" style="width:85%;height:100%;float:right;" >
						<iframe id="officeContent" name="officeContent" src="${ctx}/oa/cyTspOaMonthlyPlan/allList" width="100%" height="100%" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		var setting = {
			...
			callback:{
				onClick:function(event, treeId, treeNode){
					...
					$('#officeContent').attr("src","${ctx}/oa/cyTspOaMonthlyPlan/allList?offid="+id);
				}
			}
		};

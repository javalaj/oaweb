...
<body style="padding: 0px"  class="gray-bg">
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<doc:oaDocTitleNav activeIndex="3"></doc:oaDocTitleNav>
			<div class="ibox-content">
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="oaDoc" action="${ctx}/oa/doc/oaDoc/publicList" method="post" class="form-inline">

...
<body>
	...
	<div class="mui-content">
		...
		<div class="divcontent">
			<form action="${mctx}/oa/oaOutwork/dealFilling" method="post"
				id="inputForm">
				...
				<input type="hidden" name="id" value="${oaOutwork.id }"> <input
					type="hidden" name="token" value="${token }"> <input
					type="hidden" name="procInsId" value="${oaOutwork.procInsId }"><input
					type="hidden" name="fileId" value="${oaOutwork.fileId }"><input
				...
				<input type="hidden" value="${oaOutwork.cost}" name="cost" /> <input
					type="hidden" value="${oaOutwork.examname}" name="examname" /> <input
					type="hidden" value="${oaOutwork.examtext}" name="examtext" /> <input
					type="hidden" value="${oaOutwork.examname2}" name="examname2" /> <input
				...
				<input type="hidden" value="${oaOutwork.scheduleProgram}"
					name="scheduleProgram" /> <input type="hidden" name="realEndTime"
					value="<fmt:formatDate value="${oaOutwork.realEndTime}"
					pattern="yyyy-MM-dd HH:mm:ss" />" />
				<input type="hidden" value="${oaOutwork.examname3}" name="examname3" />
				<input type="hidden" value="${oaOutwork.examtext3}" name="examtext3" />
				<input type="hidden" value="${oaOutwork.fileurl}" name="fileurl" />
				...
				<ul class="mui-table-view divcontent">
					<li class="mui-table-view-cell" id="content11"><span>
							文件编号&emsp;：</span> <span>${oaOutwork.fileId }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							部门名称&emsp;：</span> <span>${oaOutwork.officeName }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							申请人&emsp;&emsp;：</span> <span>${oaOutwork.createBy.name }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							申请时间&emsp;：</span> <span><fmt:formatDate
								value="${oaOutwork.createDate }" pattern="yyyy-MM-dd HH:mm:ss" /></span>
					</li>
					<li class="mui-table-view-cell" id="content11"><span>
							出差任务&emsp;：</span> <span>${oaOutwork.task }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							项目或合同：</span> <span>${oaOutwork.projectName }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							日程安排&emsp;：</span> <span>${oaOutwork.scheduleProgram }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							目的地&emsp;&emsp;：</span> <span>${oaOutwork.address }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							访问单位&emsp;：</span> <span>${oaOutwork.unitName }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							拜访对象&emsp;：</span> <span>${oaOutwork.unitUserName }</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							开始时间&emsp;：</span> <span><fmt:formatDate
								value="${oaOutwork.startTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
					</li>
					<li class="mui-table-view-cell" id="content11"><span>
							截止时间&emsp;：</span> <span><fmt:formatDate
								value="${oaOutwork.endTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							出差费用&emsp;：</span> <span>${oaOutwork.cost}</span></li>
					<li class="mui-table-view-cell" id="content11"><span>
							确定结束时间：</span> <span><fmt:formatDate
								value="${oaOutwork.realEndTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
					</li>
					<li class="mui-table-view-cell"><span> 出差时长&emsp;：</span> <span>${oaOutwork.time}</span>
					</li>
					<li class="mui-table-view-cell" id="content11"><span>审批意见：</span>
						<span style="width:60%;"><input type="radio" class="exam" name="exam"

		...
		<div class="tab-content">
			<div class="tab-pane active" id="base">
				<table class="table table-condensed dataTables-example dataTable no-footer myoa-newitem-table">
					...
					<tr>
						<td>供应商保质期（月） <span class="help-inline"><font color="red">*</font> </span></td>
						<td>
							<form:input path="supplierWarrantyMonth" htmlEscape="false" max="1200" min="1" class="form-control number required"/>							
						</td>
					</tr>
					<tr>
						<td>供应商质保期开始日期</td>

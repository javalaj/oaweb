	...
	<div class="mui-content">
		...
		<div class="divcontent">
			<form action="${mctx}/oa/oaOutwork/dealExam3" method="post"
				...
				<input type="hidden" name="sign" value="3"> <input
				...
				<ul class="mui-table-view divcontent">
					...
					<li class="mui-table-view-cell"><span> 确定结束时间：</span> <span><fmt:formatDate
					...
					<li class="mui-table-view-cell"><span> 报销情况：</span> <input
						class="inputs" type="text" name="examtext4"></li>
				</ul>

...
<body>
	...
	<div class="mui-content">
		...
		<div class="divcontent">
			<form action="${mctx}/oa/oaOutwork/dealExam2" method="post"
				id="inputForm">
				...
				<input type="hidden" value="${oaOutwork.scheduleProgram}"
					...
					type="hidden" name="newsign" value="newsign" />
				...
				<ul class="mui-table-view divcontent">
					...
					<li class="mui-table-view-cell"><span> 审批意见：</span> <span style="width:60%;"><input
							class="exam" type="radio" name="exam" value="0"></input>同意 <input
							type="radio" class="exam" name="exam" checked="checked" value="1"></input>不同意</span></li>
					<li class="mui-table-view-cell"><span> 审批留言：</span> <input
						class="inputs" type="text" name="examtext2"></li>
				</ul>
			</form>
		</div>

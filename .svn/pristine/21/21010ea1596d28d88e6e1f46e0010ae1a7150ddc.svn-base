			...
			<div class="ibox-content">
				<form:form id="inputForm" modelAttribute="oaQualificationb" action="${ctx}/oa/qualificationb/oaQualificationb/dealExam" method="post" class="form-inline myoa-details-form">
					...
					<div class="control-group">
						...
						<form:input path="textexam" htmlEscape="false" maxlength="80" class="form-control" style="width:40%;"/>
					</div>
			
					
					<div class="form-actions" style="margin-top:15px;margin-bottom: 15px;">
						<shiro:hasPermission name="oa:qualificationb:oaQualificationb:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="提交"/>&nbsp;</shiro:hasPermission>

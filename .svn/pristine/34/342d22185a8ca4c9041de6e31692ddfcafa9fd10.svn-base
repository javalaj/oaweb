...
<div class="ibox-title">
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" class="form-inline">
		...
		<label>描述 ：<form:input path="description" htmlEscape="false" maxlength="50" class="form-control"/></label>
			<label>类型：<form:select id="type" path="type" class="selectpicker" data-style="btn-inverse" data-live-search="true"><form:option value="" label="全部分类"/><form:options items="${typeList}" htmlEscape="false"/></form:select></label>				

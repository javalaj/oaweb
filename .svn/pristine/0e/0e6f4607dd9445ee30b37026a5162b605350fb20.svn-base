...
function(i) {
    ...
    z = function(i) {
        ...
        if (a[0]) {
            ...
            o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), I()),
    ...
    K = function(i) {
        ...
        t = {},
        l = a.index();
        if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == j.mine.id && (i.mine = !0), i.system || V(i), G = JSON.parse(JSON.stringify(i)), j.base.voice && J(), !w && i.content || l === -1) {
    ...
    ei = {
        ...
        playAudio: function(i) {
            ...
            return e.play ? void(i.attr("status") ? n() : (a || (e.src = i.data("src")), e.play(), i.attr("status", "pause"), i.data("audio", e), i.find("i").html("&#xe651;"), e.onended = function() {
                n()
            })) : t.msg("您的浏览器不支持audio")
        },
    ...
    i("layim", new c)
}).addcss("modules/layim/layim.css?v=3.04Pro", "skinlayimcss");
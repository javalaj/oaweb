	...
	<div class="wrapper wrapper-content">
		...
		<!-- 		<h5>发文--审核</h5> -->
						...
						<tbody>
							...
							<%-- <tr>
								<td class="all" colspan="3"><label class="control-label">主送：</label>
									<div class="controls" style="width:20%;margin-left: -10px;"><sys:treeselect
			...
			<!-- 							<span class="help-inline" id="tip"><font color="red">*</font></span> -->
							...
							<tr>
								<td class="all" colspan="3"><label class="control-label"
									for="contenthref" style="padding-top: 0;">正文：</label> <a id="contenthref"
									href="#modal-container-262575" data-toggle="modal">正文内容</a></td>
							</tr>
			
							<tr>
								<td class="all" colspan="3"><label class="control-label"
									for="files" style="padding-top: 0;">相关部门会签：</label> <form:checkboxes path="departmentsign"
										items="${fns:getDictList('departmentsign')}" value=""
										itemLabel="label" itemValue="value" htmlEscape="false"
										class="departmentsign i-checks" disabled="true"/></td>
							</tr>
			
							<tr >
									<td colspan="3">
									<label class="control-label">附件：</label>
									<input type="hidden" id="billingFile${oaArchives.id}" value="${oaArchives.files}" />
									<div style="margin-left: 10px;float: left;"><sys:ckfinder
							...
							<tr>
								<td class="all" colspan="3"><label class="control-label">部门负责人意见： <font color="red">*</font></label>
									<form:input path="leadText" htmlEscape="false" maxlength="255"
										 class="form-control"  required="required" style="width:50%;"/><span class="help-inline">
										</span>
								</td>
							</tr>
							<tr>
								<td class="all" colspan="3">
									<label class="control-label" style="padding-top: 0;">是否提交： <font color="red">*</font></label>
									<label><input id="actor" name="Fruit" type="radio" value="1" class="required i-checks"/>同意</label>&nbsp;&nbsp;&nbsp;
									<label><input id="actor" name="Fruit" type="radio" value="2" class="required i-checks" checked="checked"/>驳回</label> 

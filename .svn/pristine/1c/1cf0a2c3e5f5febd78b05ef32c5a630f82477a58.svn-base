...
<script type="text/javascript">
	...
	function notnull() {
		var judge = true;
		$("input[name='qualityScore']").each(function() {
			var str = "";
...
<div class="ibox-title">
   ...
   <div class="ibox-content">
	...
	<div class="col-sm-12">
		...
		<form id="inputForm"   action="${ctx}/user/userWeekplan/testExam" method="post" class="form-inline">
...
<%-- 							<td style="text-align: center;">${now2.important }</td>
							...
							<td style="text-align: center;" ><input type="text"  id="qualityScore" class="form-control"   name="qualityScore" maxlength="25" style="width: 50px;" value="${now2.qualityScore }"><span class="help-inline"><font color="red">*</font></span></td>
						</tr>
						</c:forEach>
							<tr>
					<td colspan="4"></td>
					<td style="text-align: center;"><input id="btnSubmit1"
								class="btn btn-myoa-sec btn-myoa-large" type="submit" value="保 存" /> </td>
...
<!-- 	<script type="text/javascript">
		...
		function submitUserList_5() {
			...
			$
					.ajax({
						url : "${ctx}/oa/cyTspOaMonthlyPlan/save",
						type : "POST",
						...
						success : function(data) {
							if (data == "1") {
								...
								$("#messageBox").show();
								window.location.href = '${ctx}/oa/cyTspOaMonthlyPlan/form';
							} else {
								top.$.jBox.tip.mess = 1;
								...
								$("#messageBox").show();
								window.location.href = '${ctx}/oa/cyTspOaMonthlyPlan/';
							}
						},
						error : function(res) {
							top.$.jBox.tip.mess = 1;

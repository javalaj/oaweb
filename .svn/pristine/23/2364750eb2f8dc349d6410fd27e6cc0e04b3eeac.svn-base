...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<div class="row">
				<div class="col-sm-12">
					<form:form id="searchForm" modelAttribute="assetsEquipment" action="${ctx}/fixedassets/assetsEquipment/claimList?assetsEquipment.condition=2" method="post" class="breadcrumb form-search">

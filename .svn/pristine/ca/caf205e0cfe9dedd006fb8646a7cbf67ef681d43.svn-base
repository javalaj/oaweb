...
<button id="btnImport" class="btn btn-white btn-sm " style="outline-style: none;" data-toggle="tooltip" data-placement="left" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>

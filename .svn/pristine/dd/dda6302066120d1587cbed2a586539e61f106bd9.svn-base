...
<div class="ibox-title">
   ...
   <div class="ibox-content">
	...
	<form:form id="inputForm" modelAttribute="oaSign"
		action="${ctx}/oa/sign/oaSign/cmsave" method="post"
		class="form-inline">
<input type="hidden" name="token" value="${token }">
		...
		<c:if test="${not empty oaSign.signYfOpinion }">
			...
			<tr>
				<td>领导意见</td>
				<td colspan="4"><form:input path="signLdOpinion" htmlEscape="false"
						maxlength="255" cssStyle="width: 55%" class="form-control required " /><span class="help-inline"><font color="red">*</font></span></td>

			</tr>
			<tr>
				<td>是否提交</td>
				<td colspan="4"><label><input id="actor"  name="Fruit" type="radio" value="1" class="required i-checks"  checked/>同意</label>
					<label><input  id="actor"  name="Fruit" type="radio" value="2" class="required i-checks"  />驳回</label> <span

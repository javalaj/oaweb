...
<html>
	...
	<form id="inputForm"
		...
		<input type="hidden" value="${oaQualificationb.textname}" name="textname"/>
		<input type="hidden" value="${oaQualificationb.textexam}" name="textexam"/>
		...
		<ul class="mui-table-view divcontent">
			...
			<li class="mui-table-view-cell" id="content11"><span>管理员签字：</span>
				<span><input type="text" name="textname1" class="inputs"></span>
			</li>
			<li class="mui-table-view-cell" id="content11"><span>管理员意见：</span>
				<span><input type="text" name="textexam1" class="inputs" maxlength="800"></span>
			</li>	
		</ul>

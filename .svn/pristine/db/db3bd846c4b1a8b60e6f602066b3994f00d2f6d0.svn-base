...
public class Global {
	 ...
	 * @return
	 */
	public static String getWebSockertPort()
	{
		return getConfig("webSockertPort");
	}
	 ...
	 * 获取人事转正，合同到期提醒人
	 */
	public static String getTipMan() {
		return getConfig("tipMan");
	}
	...
	public static String getDefaultUser() {
		return getConfig("defaultUserLoginName");
	}
}

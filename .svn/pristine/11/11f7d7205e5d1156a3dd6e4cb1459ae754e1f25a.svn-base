				...
				<form:form id="inputForm" modelAttribute="oaEmployeeFormal"
					...
					<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
						<tr>
							...
							<td class="width-15 active">年龄<span style="color:red;margin-left:2px;">*</span></td>
							<td>
						...
						<tr>
							...
							<td><form:input path="" htmlEscape="false" maxlength="64"
								class="form-control input-sm" />
							</td>
							<td class="width-15 active">手机号码<span style="color:red;margin-left:2px;">*</span></td>
							<td colspan="3"><form:input path="phone" htmlEscape="false" maxlength="64"
								class="form-control input-sm" />
							</td>
						</tr>
						<tr>
							<td class="width-15 active">入职时间<span style="color:red;margin-left:2px;">*</span></td>
							<td colspan="5"><input
						...
						<tr>
							<td class="width-15 active">试用期薪酬<span style="color:red;margin-left:2px;">*</span></td>
							<td colspan="5"><form:input path="tryoutSalary" htmlEscape="false" maxlength="64"
							class="form-control input-sm  " />
							</td>
						</tr>
						<tr>
							<td class="width-15 active">转正时间<span style="color:red;margin-left:2px;">*</span></td>
							<td colspan="5"><input
						...
						<tr>
							<td class="width-15 active">转正期薪酬<span style="color:red;margin-left:2px;">*</span></td>
						...
						<tr>
							...
							<td colspan="5"><form:textarea path="examtext" htmlEscape="false" maxlength="255"
							class="form-control input-sm" readonly="true" /></td>
						</tr>
						<tr>
							<td class="width-15 active">部门副总意见</td>
							<td colspan="5"><form:textarea path="examtext2" htmlEscape="false" maxlength="255"
							class="form-control input-sm" readonly="true" /></td>
						</tr>
						<tr>
							<td class="width-15 active">人事行政部意见</td>
							<td colspan="5"><form:textarea path="examtext3" htmlEscape="false" maxlength="255"
							class="form-control input-sm" readonly="true"  /></td>
						</tr>
					</table>

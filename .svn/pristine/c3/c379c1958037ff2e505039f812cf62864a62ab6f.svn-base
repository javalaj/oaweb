...
<body>
	<form:form id="inputForm" modelAttribute="role" autocomplete="off" action="${ctx}/sys/role/save" method="post" class="form-horizontal" >
		...
		<table class="table table-condensed dataTables-example dataTable no-footer myoa-table-noborder">
		   <tbody>
		      <tr>
		         <td class="width-15"><label>归属机构:</label></td>
		         ...
		         <td  class="width-15"><label>角色名称: <font color="red">*</font></label></td>
		      ...
		      <tr>
		         <td class="width-15"><label>英文名称: <font color="red">*</font></label></td>
		         ...
		         <td  class="width-15"><label>角色类型:</label></td>
		         <td class="width-35"><%--
					...
					<form:select path="roleType" class="selectpicker" data-style="btn-inverse" data-live-search="true">
		      ...
		      <tr>
		         <td class="width-15"><label>是否系统数据:</label></td>
		         <td class="width-35"><form:select path="sysData" class="selectpicker" data-style="btn-inverse" data-live-search="true">
		      ...
		      <tr>
		         <td class="width-15"><label>数据范围:</label></td>
		         <td class="width-35"><form:select path="dataScope" class="selectpicker" data-style="btn-inverse" data-live-search="true">
